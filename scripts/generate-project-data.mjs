...
const curated = [
  ...
  },
  {
    ...
    architecture: ["User preference input", "Profile and item attributes", "Similarity or rule matching", "Ranked recommendation output"],
    capabilities: ["Capture choices and interests", "Match preferences", "Explain recommendation logic", "Display ranked items"],
    technologies: ["Python", "Recommendation Systems"],
    signals: { files: 1, code: 0, tests: 0, notebooks: 0 },
    status: "Pending",
  ...
  },
  {
    ...
    architecture: ["Raw image ingestion", "Image preprocessing", "OCR or object detection", "Validated recognition output"],
    capabilities: ["Process unstructured visual data", "Recognize text or objects", "Report confidence", "Produce machine-readable results"],
    technologies: ["Python", "OpenCV", "Tesseract", "MobileNet SSD"],
    signals: { files: 1, code: 0, tests: 0, notebooks: 0 },
    status: "Pending",
    url: "https://github.com/JeanLoa/DecodeLabs",
    featured: false,
