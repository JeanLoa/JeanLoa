...
const curated = [
  {
    ...
    architecture: ["Reusable conversation core", "Normalized intent index", "SQLite persistence", "Streamlit presentation"],
    capabilities: ["Eight bilingual intents", "Multiple persistent conversations", "JSON conversation export", "Decision trace and controlled fallback"],
    technologies: ["Python", "Streamlit", "SQLite"],
    signals: { files: 13, code: 6, tests: 2, notebooks: 0 },
    status: "Completed",
  ...
  },
  {
    ...
    architecture: ["Validated raw data", "Reproducible ETL", "Leakage-safe training pipeline", "Interactive evaluation surface"],
    capabilities: ["KNN tuning with cross-validation", "Accuracy and macro F1", "Confusion matrix and class metrics", "Interactive flower prediction"],
    technologies: ["Python", "Streamlit", "scikit-learn", "Pandas"],
    signals: { files: 22, code: 11, tests: 1, notebooks: 0 },
    status: "Completed",
  ...
  },
  {
    ...
    architecture: ["Canonical profile vocabulary", "TF-IDF vectorization", "Cosine-similarity ranking", "Streamlit explanation workspace"],
    capabilities: ["Top-three deterministic ranking", "Matched skills and gap analysis", "Cold-start presets and fallback", "SQLite history and JSON export"],
    technologies: ["Python", "Streamlit", "scikit-learn", "TF-IDF", "Cosine Similarity", "SQLite"],
    signals: { files: 50, code: 8, tests: 1, notebooks: 0 },
    status: "Completed",
  ...
  },
  {
    ...
    architecture: ["Validated image ingestion", "OpenCV preprocessing pipeline", "Tesseract OCR adapter", "Confidence-gated evidence workspace"],
    capabilities: ["Adaptive and Otsu thresholding", "Safe foreground deskewing", "Word confidence and bounding boxes", "TXT and JSON exports"],
    technologies: ["Python", "Streamlit", "OpenCV", "Tesseract", "Pillow"],
    signals: { files: 42, code: 11, tests: 1, notebooks: 0 },
    status: "Completed",
  ...
  },
  {
    ...
    architecture: ["DRF validation and resources", "Geoapify provider integration", "Route corridor selection", "Fuel optimization services"],
    capabilities: ["US geocoding and routing", "GeoJSON route output", "Per-stop gallons and cost", "Structured errors and mocked provider tests"],
    technologies: ["Python", "Django", "Django REST Framework", "HTTPX", "Geoapify", "SQLite"],
    signals: { files: 59, code: 38, tests: 9, notebooks: 0 },
    status: "Completed",
