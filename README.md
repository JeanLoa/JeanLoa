...
<p>
  ...
  <img src="https://img.shields.io/badge/Open%20to-International%20Opportunities-16A34A?style=flat-square" alt="Open to international opportunities" />
</p>
...
<table>
  <tr>
    ...
    <td width="33%" valign="top">
      <h3>LowCortisol</h3>
      <p><strong>Water & Gas Operations Platform</strong></p>
      <p>
  ...
  <tr>
    <td width="33%" valign="top">
      ...
      <p><strong>Applied AI Internship Portfolio</strong></p>
      <p>
    ...
    <td width="33%" valign="top">
      ...
      <p><strong>RAG, Tools & Autonomous Workflows</strong></p>
      <p>
    ...
    <td width="33%" valign="top">
      ...
      <p><strong>Multi-Cloud Delivery</strong></p>
      <p>
...
The ecosystem below defines the full technical scope of my Software Engineering and AI Engineering portfolio.
...
```mermaid
flowchart LR
    A[Domain and Data] --> B[Software and AI Services]
    B --> C[APIs and Agentic Workflows]
    C --> D[Product Experience]
    D --> E[Testing and Evaluation]
    E --> F[Cloud Delivery]
    F --> G[Observability and Iteration]
```
...
> Design the boundaries.<br>
> Build the evidence.<br>
> Automate the delivery.<br>
> Measure the outcome.
